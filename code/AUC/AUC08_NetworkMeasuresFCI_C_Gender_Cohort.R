...
#######################################################
load("data/ROC_AUC/ROC08_NetworkMeasuresFCI_C_gender_cohort_logreg.Rdata")
load("data/ROC_AUC/ROC08_NetworkMeasuresFCI_C_gender_cohort_lda.Rdata")
load("data/ROC_AUC/ROC_NetworkMeasuresFCI_C_gender_cohort_qda.Rdata")
load("data/ROC_AUC/ROC_NetworkMeasuresFCI_C_gender_cohort_knn.Rdata")
