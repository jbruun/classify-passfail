...
ROC_PS_log<-list()
for(i in 1:100){
  predPS_x<-jackPredLog(centPS,predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
...
ROC_CD_log<-list()
for(i in 1:100){
  predCD_x<-jackPredLog(centCD,predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
...
ROC_ICS_log<-list()
for(i in 1:100){
  predICS_x<-jackPredLog(centICS,predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
...
for(i in 1:100){
  predPS_x<-jackPredLog(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredLog(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLog(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredLog(centPS,predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredLog(centCD,predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLog(centICS,predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredLog(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredLog(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLog(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
ROC_PS_log_PRH<-list()
for(i in 1:100){
  predPS_x<-jackPredLog(centPS,predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
ROC_CD_log_PRH<-list()
for(i in 1:100){
  predCD_x<-jackPredLog(centCD,predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLog(centICS,predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredLog(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredLog(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLog(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
ROC_PS_log_TEH<-list()
for(i in 1:100){
  predPS_x<-jackPredLog(centPS,predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
ROC_CD_log_TEH<-list()
for(i in 1:100){
  predCD_x<-jackPredLog(centCD,predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLog(centICS,predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredLog(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredLog(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLog(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
ROC_PS_log_TE<-list()
for(i in 1:100){
  predPS_x<-jackPredLog(centPS,predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_PS_log_TE[[i]]<-ROC
}
...
ROC_CD_log_TE<-list()
for(i in 1:100){
  predCD_x<-jackPredLog(centCD,predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
  ROC_CD_log_TE[[i]]<-ROC
}
...
ROC_ICS_log_TE<-list()
for(i in 1:100){
  predICS_x<-jackPredLog(centICS,predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredLog(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredLog(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLog(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
ROC_PS_log_H<-list()
for(i in 1:100){
  predPS_x<-jackPredLog(centPS,predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_PS_log_H[[i]]<-ROC
}
...
ROC_CD_log_H<-list()
for(i in 1:100){
  predCD_x<-jackPredLog(centCD,predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
  ROC_CD_log_H[[i]]<-ROC
}
...
ROC_ICS_log_H<-list()
for(i in 1:100){
  predICS_x<-jackPredLog(centICS,predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
  ROC_ICS_log_H[[i]]<-ROC
}
...
for(i in 1:100){
  predPS_x<-jackPredLog(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredLog(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLog(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
ROC_PS_log_PR<-list()
for(i in 1:100){
  predPS_x<-jackPredLog(centPS,predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_PS_log_PR[[i]]<-ROC
}
...
ROC_CD_log_PR<-list()
for(i in 1:100){
  predCD_x<-jackPredLog(centCD,predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
  ROC_CD_log_PR[[i]]<-ROC
}
...
ROC_ICS_log_PR<-list()
for(i in 1:100){
  predICS_x<-jackPredLog(centICS,predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredLog(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredLog(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLog(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
save(ROC_PS_log,ROC_CD_log,ROC_ICS_log, ROC_PS_justpass_log,ROC_CD_justpass_log,ROC_ICS_justpass_log,
     ...
     file="data/ROC_NetworkMeasuresFCI_C_gender_logreg.Rdata")
...
ROC_PS_lda<-list()
for(i in 1:100){
  predPS_x<-jackPredLDA(centPS,predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_PS_lda[[i]]<-ROC
}
...
ROC_CD_lda<-list()
for(i in 1:100){
  predCD_x<-jackPredLDA(centCD,predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
  ROC_CD_lda[[i]]<-ROC
}
...
ROC_ICS_lda<-list()
for(i in 1:100){
  predICS_x<-jackPredLDA(centICS,predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
  ROC_ICS_lda[[i]]<-ROC
}
...
for(i in 1:100){
  predPS_x<-jackPredLDA(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredLDA(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLDA(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredLDA(centPS,predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredLDA(centCD,predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLDA(centICS,predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredLDA(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredLDA(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLDA(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
ROC_PS_lda_PRH<-list()
for(i in 1:100){
  predPS_x<-jackPredLDA(centPS,predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
ROC_CD_lda_PRH<-list()
for(i in 1:100){
  predCD_x<-jackPredLDA(centCD,predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLDA(centICS,predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredLDA(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredLDA(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLDA(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
ROC_PS_lda_TEH<-list()
for(i in 1:100){
  predPS_x<-jackPredLDA(centPS,predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
ROC_CD_lda_TEH<-list()
for(i in 1:100){
  predCD_x<-jackPredLDA(centCD,predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLDA(centICS,predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredLDA(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredLDA(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLDA(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
ROC_PS_lda_TE<-list()
for(i in 1:100){
  predPS_x<-jackPredLDA(centPS,predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_PS_lda_TE[[i]]<-ROC
}
...
ROC_CD_lda_TE<-list()
for(i in 1:100){
  predCD_x<-jackPredLDA(centCD,predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
  ROC_CD_lda_TE[[i]]<-ROC
}
...
ROC_ICS_lda_TE<-list()
for(i in 1:100){
  predICS_x<-jackPredLDA(centICS,predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredLDA(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredLDA(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLDA(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
ROC_PS_lda_H<-list()
for(i in 1:100){
  predPS_x<-jackPredLDA(centPS,predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_PS_lda_H[[i]]<-ROC
}
...
ROC_CD_lda_H<-list()
for(i in 1:100){
  predCD_x<-jackPredLDA(centCD,predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
  ROC_CD_lda_H[[i]]<-ROC
}
...
ROC_ICS_lda_H<-list()
for(i in 1:100){
  predICS_x<-jackPredLDA(centICS,predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
  ROC_ICS_lda_H[[i]]<-ROC
}
...
for(i in 1:100){
  predPS_x<-jackPredLDA(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredLDA(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLDA(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
ROC_PS_lda_PR<-list()
for(i in 1:100){
  predPS_x<-jackPredLDA(centPS,predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_PS_lda_PR[[i]]<-ROC
}
...
ROC_CD_lda_PR<-list()
for(i in 1:100){
  predCD_x<-jackPredLDA(centCD,predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
  ROC_CD_lda_PR[[i]]<-ROC
}
...
ROC_ICS_lda_PR<-list()
for(i in 1:100){
  predICS_x<-jackPredLDA(centICS,predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredLDA(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredLDA(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredLDA(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
save(ROC_PS_lda,ROC_CD_lda,ROC_ICS_lda, ROC_PS_justpass_lda,ROC_CD_justpass_lda,ROC_ICS_justpass_lda,
     ...
     file="data/ROC_NetworkMeasuresFCI_C_gender_lda.Rdata")
...
ROC_PS_qda<-list()
for(i in 1:100){
  predPS_x<-jackPredQDA(centPS,predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_PS_qda[[i]]<-ROC
}
...
ROC_CD_qda<-list()
for(i in 1:100){
  predCD_x<-jackPredQDA(centCD,predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
  ROC_CD_qda[[i]]<-ROC
}
...
ROC_ICS_qda<-list()
for(i in 1:100){
  predICS_x<-jackPredQDA(centICS,predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
  ROC_ICS_qda[[i]]<-ROC
}
...
for(i in 1:100){
  predPS_x<-jackPredQDA(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredQDA(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredQDA(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredQDA(centPS,predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredQDA(centCD,predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredQDA(centICS,predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredQDA(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredQDA(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredQDA(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
ROC_PS_qda_PRH<-list()
for(i in 1:100){
  predPS_x<-jackPredQDA(centPS,predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
ROC_CD_qda_PRH<-list()
for(i in 1:100){
  predCD_x<-jackPredQDA(centCD,predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredQDA(centICS,predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredQDA(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredQDA(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredQDA(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
ROC_PS_qda_TEH<-list()
for(i in 1:100){
  predPS_x<-jackPredQDA(centPS,predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
ROC_CD_qda_TEH<-list()
for(i in 1:100){
  predCD_x<-jackPredQDA(centCD,predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredQDA(centICS,predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredQDA(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredQDA(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredQDA(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
ROC_PS_qda_TE<-list()
for(i in 1:100){
  predPS_x<-jackPredQDA(centPS,predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_PS_qda_TE[[i]]<-ROC
}
...
ROC_CD_qda_TE<-list()
for(i in 1:100){
  predCD_x<-jackPredQDA(centCD,predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
  ROC_CD_qda_TE[[i]]<-ROC
}
...
ROC_ICS_qda_TE<-list()
for(i in 1:100){
  predICS_x<-jackPredQDA(centICS,predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredQDA(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredQDA(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredQDA(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
ROC_PS_qda_H<-list()
for(i in 1:100){
  predPS_x<-jackPredQDA(centPS,predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_PS_qda_H[[i]]<-ROC
}
...
ROC_CD_qda_H<-list()
for(i in 1:100){
  predCD_x<-jackPredQDA(centCD,predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
  ROC_CD_qda_H[[i]]<-ROC
}
...
ROC_ICS_qda_H<-list()
for(i in 1:100){
  predICS_x<-jackPredQDA(centICS,predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
  ROC_ICS_qda_H[[i]]<-ROC
}
...
for(i in 1:100){
  predPS_x<-jackPredQDA(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredQDA(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredQDA(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","Hide"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
ROC_PS_qda_PR<-list()
for(i in 1:100){
  predPS_x<-jackPredQDA(centPS,predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_PS_qda_PR[[i]]<-ROC
}
...
ROC_CD_qda_PR<-list()
for(i in 1:100){
  predCD_x<-jackPredQDA(centCD,predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
  ROC_CD_qda_PR[[i]]<-ROC
}
...
ROC_ICS_qda_PR<-list()
for(i in 1:100){
  predICS_x<-jackPredQDA(centICS,predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
for(i in 1:100){
  predPS_x<-jackPredQDA(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
...
for(i in 1:100){
  predCD_x<-jackPredQDA(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predCD_x)
...
for(i in 1:100){
  predICS_x<-jackPredQDA(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank"),p=i/100)
  ROC<-ROCplusWeeks(predICS_x)
...
save(ROC_PS_qda,ROC_CD_qda,ROC_ICS_qda, ROC_PS_justpass_qda,ROC_CD_justpass_qda,ROC_ICS_justpass_qda,
     ...
     file="data/ROC_NetworkMeasuresFCI_C_gender_qda.Rdata")
...
ROC_PS_knn<-list()
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),nK = i)
...
ROC_CD_knn<-list()
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD,predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),nK = i)
...
ROC_ICS_knn<-list()
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS,predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),nK = i)
...
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
...
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt", "Hide"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,predictors = c("gender","fci_pre_c","PageRank","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
...
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD,predictors = c("gender","fci_pre_c","PageRank","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS,predictors = c("gender","fci_pre_c","PageRank","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
...
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
ROC_PS_knn_PRH<-list()
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,predictors = c("gender","fci_pre_c","PageRank","Hide"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
...
ROC_CD_knn_PRH<-list()
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD,predictors = c("gender","fci_pre_c","PageRank","Hide"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS,predictors = c("gender","fci_pre_c","PageRank","Hide"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","Hide"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
...
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","Hide"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank","Hide"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
ROC_PS_knn_TEH<-list()
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,predictors = c("gender","fci_pre_c","tarEnt","Hide"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
...
ROC_CD_knn_TEH<-list()
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD,predictors = c("gender","fci_pre_c","tarEnt","Hide"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS,predictors = c("gender","fci_pre_c","tarEnt","Hide"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt","Hide"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
...
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt","Hide"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt","Hide"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
ROC_PS_knn_TE<-list()
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,predictors = c("gender","fci_pre_c","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
  ROC_PS_knn_TE[[i]]<-ROC
}
...
ROC_CD_knn_TE<-list()
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD,predictors = c("gender","fci_pre_c","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
  ROC_CD_knn_TE[[i]]<-ROC
}
...
ROC_ICS_knn_TE<-list()
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS,predictors = c("gender","fci_pre_c","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
...
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
ROC_PS_knn_H<-list()
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,predictors = c("gender","fci_pre_c","Hide"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
  ROC_PS_knn_H[[i]]<-ROC
}
...
ROC_CD_knn_H<-list()
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD,predictors = c("gender","fci_pre_c","Hide"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
  ROC_CD_knn_H[[i]]<-ROC
}
...
ROC_ICS_knn_H<-list()
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS,predictors = c("gender","fci_pre_c","Hide"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
  ROC_ICS_knn_H[[i]]<-ROC
}
...
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","Hide"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
...
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","Hide"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","Hide"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
ROC_PS_knn_PR<-list()
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,predictors = c("gender","fci_pre_c","PageRank"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
  ROC_PS_knn_PR[[i]]<-ROC
}
...
ROC_CD_knn_PR<-list()
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD,predictors = c("gender","fci_pre_c","PageRank"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
  ROC_CD_knn_PR[[i]]<-ROC
}
...
ROC_ICS_knn_PR<-list()
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS,predictors = c("gender","fci_pre_c","PageRank"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
...
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS, outcome = "justpass",predictors = c("gender","fci_pre_c","PageRank"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
save(ROC_PS_knn,ROC_CD_knn,ROC_ICS_knn, ROC_PS_justpass_knn,ROC_CD_justpass_knn,ROC_ICS_justpass_knn,
     ...
     file="data/ROC_NetworkMeasuresFCI_C_gender_knn.Rdata")
...
#######################################################
load("data/ROC_NetworkMeasuresFCI_C_gender_logreg.Rdata")
load("data/ROC_NetworkMeasuresFCI_C_gender_lda.Rdata")
load("data/ROC_NetworkMeasuresFCI_C_gender_qda.Rdata")
load("data/ROC_NetworkMeasuresFCI_C_gender_knn.Rdata")
