...
ROC_GCF_log<-list()
for(i in 1:100){
  predPS_x<-kfoldLog(centPS,predictors = c("gender", "cohort", "fci_pre"),p=i/100)
...
ROC_GC_log<-list()
for(i in 1:100){
  predPS_x<-kfoldLog(centPS,predictors = c("gender",  "cohort"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_GC_log[[i]]<-ROC
}
...
ROC_GF_log<-list()
for(i in 1:100){
  predPS_x<-kfoldLog(centPS,predictors = c("gender",  "fci_pre"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_GF_log[[i]]<-ROC
}
...
ROC_CF_log<-list()
for(i in 1:100){
  predPS_x<-kfoldLog(centPS,predictors = c("cohort",  "fci_pre"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_CF_log[[i]]<-ROC
}
...
ROC_G_log<-list()
for(i in 1:100){
  predPS_x<-kfoldLog(centPS,predictors = c("gender"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_G_log[[i]]<-ROC
}
...
ROC_C_log<-list()
for(i in 1:100){
  predPS_x<-kfoldLog(centPS,predictors = c("cohort"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_C_log[[i]]<-ROC
}
...
ROC_F_log<-list()
for(i in 1:100){
  predPS_x<-kfoldLog(centPS,predictors = c("fci_pre"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_F_log[[i]]<-ROC
}
...
ROC_GCF_lda<-list()
for(i in 1:100){
  predPS_x<-kfoldLDA(centPS,predictors = c("gender", "cohort", "fci_pre"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_GCF_lda[[i]]<-ROC
}
...
ROC_GC_lda<-list()
for(i in 1:100){
  predPS_x<-kfoldLDA(centPS,predictors = c("gender",  "cohort"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_GC_lda[[i]]<-ROC
}
...
ROC_GF_lda<-list()
for(i in 1:100){
  predPS_x<-kfoldLDA(centPS,predictors = c("gender",  "fci_pre"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_GF_lda[[i]]<-ROC
}
...
ROC_CF_lda<-list()
for(i in 1:100){
  predPS_x<-kfoldLDA(centPS,predictors = c("cohort",  "fci_pre"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_CF_lda[[i]]<-ROC
}
...
ROC_G_lda<-list()
for(i in 1:100){
  predPS_x<-kfoldLDA(centPS,predictors = c("gender"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_G_lda[[i]]<-ROC
}
...
ROC_C_lda<-list()
for(i in 1:100){
  predPS_x<-kfoldLDA(centPS,predictors = c("cohort"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_C_lda[[i]]<-ROC
}
...
ROC_F_lda<-list()
for(i in 1:100){
  predPS_x<-kfoldLDA(centPS,predictors = c("fci_pre"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_F_lda[[i]]<-ROC
}
...
ROC_GCF_qda<-list()
for(i in 1:100){
  predPS_x<-kfoldQDA(centPS,predictors = c("gender", "cohort", "fci_pre"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_GCF_qda[[i]]<-ROC
}
...
ROC_GC_qda<-list()
for(i in 1:100){
  predPS_x<-kfoldQDA(centPS,predictors = c("gender",  "cohort"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_GC_qda[[i]]<-ROC
}
...
ROC_GF_qda<-list()
for(i in 1:100){
  predPS_x<-kfoldQDA(centPS,predictors = c("gender",  "fci_pre"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_GF_qda[[i]]<-ROC
}
...
ROC_CF_qda<-list()
for(i in 1:100){
  predPS_x<-kfoldQDA(centPS,predictors = c("cohort",  "fci_pre"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_CF_qda[[i]]<-ROC
}
...
ROC_G_qda<-list()
for(i in 1:100){
  predPS_x<-kfoldQDA(centPS,predictors = c("gender"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_G_qda[[i]]<-ROC
}
...
ROC_C_qda<-list()
for(i in 1:100){
  predPS_x<-kfoldQDA(centPS,predictors = c("cohort"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_C_qda[[i]]<-ROC
}
...
ROC_F_qda<-list()
for(i in 1:100){
  predPS_x<-kfoldQDA(centPS,predictors = c("fci_pre"),p=i/100)
  ROC<-ROCplusWeeks(predPS_x)
  ROC_F_qda[[i]]<-ROC
}
