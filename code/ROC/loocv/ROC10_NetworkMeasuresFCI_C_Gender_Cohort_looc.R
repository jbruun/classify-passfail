...
######PR-TE-H Models######
predPS_log_PTH<-jackPredLog(centPS,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
rocPS_log_PTH<-list()
...
predCD_log_PTH<-jackPredLog(centCD,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
rocCD_log_PTH<-list()
...
predICS_log_PTH<-jackPredLog(centICS,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
rocICS_log_PTH<-list()
...
###JUST PASS
predPS_jp_log_PTH<-jackPredLog(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
...
predCD_jp_log_PTH<-jackPredLog(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
...
predICS_jp_log_PTH<-jackPredLog(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
...
######PR TE models######
predPS_log_PT<-jackPredLog(centPS,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
rocPS_log_PT<-list()
...
##CD layer
predCD_log_PT<-jackPredLog(centCD,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
rocCD_log_PT<-list()
...
#ICS layer
predICS_log_PT<-jackPredLog(centICS,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
rocICS_log_PT<-list()
...
###JUST PASS
predPS_jp_log_PT<-jackPredLog(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
...
predCD_jp_log_PT<-jackPredLog(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
...
predICS_jp_log_PT<-jackPredLog(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
...
######PR H Models######
predPS_log_PH<-jackPredLog(centPS,predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
rocPS_log_PH<-list()
...
##CD layer
predCD_log_PH<-jackPredLog(centCD,predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
rocCD_log_PH<-list()
...
#ICS layer
predICS_log_PH<-jackPredLog(centICS,predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
rocICS_log_PH<-list()
...
###JUST PASS
##PS layer
predPS_jp_log_PH<-jackPredLog(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
...
#CD Layer
predCD_jp_log_PH<-jackPredLog(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
...
#ICS layer
predICS_jp_log_PH<-jackPredLog(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
...
######TE-H models######
#PS layer
predPS_log_TH<-jackPredLog(centPS,predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
rocPS_log_TH<-list()
...
##CD layer
predCD_log_TH<-jackPredLog(centCD,predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
rocCD_log_TH<-list()
...
#ICS layer
predICS_log_TH<-jackPredLog(centICS,predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
rocICS_log_TH<-list()
...
###JUST PASS
#PS Layer
predPS_jp_log_TH<-jackPredLog(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
...
#CD layer
predCD_jp_log_TH<-jackPredLog(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
...
#ICS Layer
predICS_jp_log_TH<-jackPredLog(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
...
######TE models######
#PS layer
predPS_log_T<-jackPredLog(centPS,predictors = c("fci_pre_c","gender","cohort","tarEnt"))
rocPS_log_T<-list()
...
##CD layer
predCD_log_T<-jackPredLog(centCD,predictors = c("fci_pre_c","gender","cohort","tarEnt"))
rocCD_log_T<-list()
...
#ICS layer
predICS_log_T<-jackPredLog(centICS,predictors = c("fci_pre_c","gender","cohort","tarEnt"))
rocICS_log_T<-list()
...
###JUST PASS
#PS layer
predPS_jp_log_T<-jackPredLog(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt"))
rocPS_jp_log_T<-list()
...
#CD layer
predCD_jp_log_T<-jackPredLog(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt"))
rocCD_jp_log_T<-list()
...
#ICS layer
predICS_jp_log_T<-jackPredLog(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt"))
...
######H models######
#PS layer
predPS_log_H<-jackPredLog(centPS,predictors = c("fci_pre_c","gender","cohort", "Hide"))
rocPS_log_H<-list()
...
##CD layer
predCD_log_H<-jackPredLog(centCD,predictors = c("fci_pre_c","gender","cohort", "Hide"))
rocCD_log_H<-list()
...
#ICS layer
predICS_log_H<-jackPredLog(centICS,predictors = c("fci_pre_c","gender","cohort", "Hide"))
rocICS_log_H<-list()
...
###JUST PASS
predPS_jp_log_H<-jackPredLog(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort", "Hide"))
rocPS_jp_log_H<-list()
...
predCD_jp_log_H<-jackPredLog(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort", "Hide"))
rocCD_jp_log_H<-list()
...
predICS_jp_log_H<-jackPredLog(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort", "Hide"))
...
######PR models######
#PS layer
predPS_log_P<-jackPredLog(centPS,predictors = c("fci_pre_c","gender","cohort","PageRank"))
rocPS_log_P<-list()
...
##CD layer
predCD_log_P<-jackPredLog(centCD,predictors = c("fci_pre_c","gender","cohort","PageRank"))
rocCD_log_P<-list()
...
#ICS layer
predICS_log_P<-jackPredLog(centICS,predictors = c("fci_pre_c","gender","cohort","PageRank"))
rocICS_log_P<-list()
...
###JUST PASS
#PS layer
predPS_jp_log_P<-jackPredLog(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank"))
rocPS_jp_log_P<-list()
...
#CD layer
predCD_jp_log_P<-jackPredLog(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank"))
rocCD_jp_log_P<-list()
...
#ICS layer
predICS_jp_log_P<-jackPredLog(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank"))
...
####PLOTTING####
pdf(file = "plots/ROC_AUC_plots/AUC10_NetworkMeasuresFCI_C_Gender_Cohort_log_weightedMeans.pdf",   # The directory you want to save the file in
...
dev.off()
####ROC curves####
pdf(file = "plots/ROC_AUC_plots/ROC10_log_pf.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
...
dev.off()
pdf(file = "plots/ROC_AUC_plots/ROC10_log_jpf.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 14) # The height of the plot in inches
par(mfrow=c(4,2))
...
######Run models and calculate AUC (with CI)####
######PR-TE-H Models######
predPS_lda_PTH<-jackPredLDA(centPS,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
rocPS_lda_PTH<-list()
...
predCD_lda_PTH<-jackPredLDA(centCD,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
rocCD_lda_PTH<-list()
...
predICS_lda_PTH<-jackPredLDA(centICS,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
rocICS_lda_PTH<-list()
...
###JUST PASS
predPS_jp_lda_PTH<-jackPredLDA(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
...
predCD_jp_lda_PTH<-jackPredLDA(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
...
predICS_jp_lda_PTH<-jackPredLDA(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
...
######PR TE models######
predPS_lda_PT<-jackPredLDA(centPS,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
rocPS_lda_PT<-list()
...
##CD layer
predCD_lda_PT<-jackPredLDA(centCD,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
rocCD_lda_PT<-list()
...
#ICS layer
predICS_lda_PT<-jackPredLDA(centICS,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
rocICS_lda_PT<-list()
...
###JUST PASS
predPS_jp_lda_PT<-jackPredLDA(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
...
predCD_jp_lda_PT<-jackPredLDA(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
...
predICS_jp_lda_PT<-jackPredLDA(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
...
######PR H Models######
predPS_lda_PH<-jackPredLDA(centPS,predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
rocPS_lda_PH<-list()
...
##CD layer
predCD_lda_PH<-jackPredLDA(centCD,predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
rocCD_lda_PH<-list()
...
#ICS layer
predICS_lda_PH<-jackPredLDA(centICS,predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
rocICS_lda_PH<-list()
...
###JUST PASS
##PS layer
predPS_jp_lda_PH<-jackPredLDA(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
...
#CD Layer
predCD_jp_lda_PH<-jackPredLDA(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
...
#ICS layer
predICS_jp_lda_PH<-jackPredLDA(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
...
######TE-H models######
#PS layer
predPS_lda_TH<-jackPredLDA(centPS,predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
rocPS_lda_TH<-list()
...
##CD layer
predCD_lda_TH<-jackPredLDA(centCD,predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
rocCD_lda_TH<-list()
...
#ICS layer
predICS_lda_TH<-jackPredLDA(centICS,predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
rocICS_lda_TH<-list()
...
###JUST PASS
#PS Layer
predPS_jp_lda_TH<-jackPredLDA(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
...
#CD layer
predCD_jp_lda_TH<-jackPredLDA(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
...
#ICS Layer
predICS_jp_lda_TH<-jackPredLDA(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
...
######TE models######
#PS layer
predPS_lda_T<-jackPredLDA(centPS,predictors = c("fci_pre_c","gender","cohort","tarEnt"))
rocPS_lda_T<-list()
...
##CD layer
predCD_lda_T<-jackPredLDA(centCD,predictors = c("fci_pre_c","gender","cohort","tarEnt"))
rocCD_lda_T<-list()
...
#ICS layer
predICS_lda_T<-jackPredLDA(centICS,predictors = c("fci_pre_c","gender","cohort","tarEnt"))
rocICS_lda_T<-list()
...
###JUST PASS
#PS layer
predPS_jp_lda_T<-jackPredLDA(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt"))
rocPS_jp_lda_T<-list()
...
#CD layer
predCD_jp_lda_T<-jackPredLDA(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt"))
rocCD_jp_lda_T<-list()
...
#ICS layer
predICS_jp_lda_T<-jackPredLDA(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt"))
...
######H models######
#PS layer
predPS_lda_H<-jackPredLDA(centPS,predictors = c("fci_pre_c","gender","cohort", "Hide"))
rocPS_lda_H<-list()
...
##CD layer
predCD_lda_H<-jackPredLDA(centCD,predictors = c("fci_pre_c","gender","cohort", "Hide"))
rocCD_lda_H<-list()
...
#ICS layer
predICS_lda_H<-jackPredLDA(centICS,predictors = c("fci_pre_c","gender","cohort", "Hide"))
rocICS_lda_H<-list()
...
###JUST PASS
predPS_jp_lda_H<-jackPredLDA(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort", "Hide"))
rocPS_jp_lda_H<-list()
...
predCD_jp_lda_H<-jackPredLDA(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort", "Hide"))
rocCD_jp_lda_H<-list()
...
predICS_jp_lda_H<-jackPredLDA(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort", "Hide"))
...
######PR models######
#PS layer
predPS_lda_P<-jackPredLDA(centPS,predictors = c("fci_pre_c","gender","cohort","PageRank"))
rocPS_lda_P<-list()
...
##CD layer
predCD_lda_P<-jackPredLDA(centCD,predictors = c("fci_pre_c","gender","cohort","PageRank"))
rocCD_lda_P<-list()
...
#ICS layer
predICS_lda_P<-jackPredLDA(centICS,predictors = c("fci_pre_c","gender","cohort","PageRank"))
rocICS_lda_P<-list()
...
###JUST PASS
#PS layer
predPS_jp_lda_P<-jackPredLDA(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank"))
rocPS_jp_lda_P<-list()
...
#CD layer
predCD_jp_lda_P<-jackPredLDA(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank"))
rocCD_jp_lda_P<-list()
...
#ICS layer
predICS_jp_lda_P<-jackPredLDA(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank"))
...
####PLOTTING####
pdf(file = "plots/ROC_AUC_plots/AUC10_NetworkMeasuresFCI_C_Gender_Cohort_lda_weightedMeans.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,2))
x<-c(1:7)
...
dev.off()
####ROC curves####
pdf(file = "plots/ROC_AUC_plots/ROC10_lda_pf.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 14) # The height of the plot in inches
par(mfrow=c(4,2))
...
dev.off()
pdf(file = "plots/ROC_AUC_plots/ROC10_lda_jpf.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 14) # The height of the plot in inches
par(mfrow=c(4,2))
...
######Run models and calculate AUC (with CI)####
######PR-TE-H Models######
predPS_qda_PTH<-jackPredQDA(centPS,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
rocPS_qda_PTH<-list()
...
predCD_qda_PTH<-jackPredQDA(centCD,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
rocCD_qda_PTH<-list()
...
predICS_qda_PTH<-jackPredQDA(centICS,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
rocICS_qda_PTH<-list()
...
###JUST PASS
predPS_jp_qda_PTH<-jackPredQDA(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
...
####RANK DEF. PROBLEM####
#predCD_jp_qda_PTH<-jackPredQDA(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
...
predICS_jp_qda_PTH<-jackPredQDA(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"))
...
######PR TE models######
predPS_qda_PT<-jackPredQDA(centPS,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
rocPS_qda_PT<-list()
...
##CD layer
predCD_qda_PT<-jackPredQDA(centCD,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
rocCD_qda_PT<-list()
...
#ICS layer
predICS_qda_PT<-jackPredQDA(centICS,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
rocICS_qda_PT<-list()
...
###JUST PASS
predPS_jp_qda_PT<-jackPredQDA(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
...
####Rank def. problem####
#predCD_jp_qda_PT<-jackPredQDA(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
...
predICS_jp_qda_PT<-jackPredQDA(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"))
...
######PR H Models######
predPS_qda_PH<-jackPredQDA(centPS,predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
rocPS_qda_PH<-list()
...
##CD layer
predCD_qda_PH<-jackPredQDA(centCD,predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
rocCD_qda_PH<-list()
...
#ICS layer
predICS_qda_PH<-jackPredQDA(centICS,predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
rocICS_qda_PH<-list()
...
###JUST PASS
##PS layer
predPS_jp_qda_PH<-jackPredQDA(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
...
#CD Layer
predCD_jp_qda_PH<-jackPredQDA(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
...
#ICS layer
predICS_jp_qda_PH<-jackPredQDA(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank", "Hide"))
...
######TE-H models######
#PS layer
predPS_qda_TH<-jackPredQDA(centPS,predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
rocPS_qda_TH<-list()
...
##CD layer
predCD_qda_TH<-jackPredQDA(centCD,predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
rocCD_qda_TH<-list()
...
#ICS layer
predICS_qda_TH<-jackPredQDA(centICS,predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
rocICS_qda_TH<-list()
...
###JUST PASS
#PS Layer
predPS_jp_qda_TH<-jackPredQDA(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
...
####Rank def. problem####
#CD layer
#predCD_jp_qda_TH<-jackPredQDA(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
...
#ICS Layer
predICS_jp_qda_TH<-jackPredQDA(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"))
...
######TE models######
#PS layer
predPS_qda_T<-jackPredQDA(centPS,predictors = c("fci_pre_c","gender","cohort","tarEnt"))
rocPS_qda_T<-list()
...
##CD layer
predCD_qda_T<-jackPredQDA(centCD,predictors = c("fci_pre_c","gender","cohort","tarEnt"))
rocCD_qda_T<-list()
...
#ICS layer
predICS_qda_T<-jackPredQDA(centICS,predictors = c("fci_pre_c","gender","cohort","tarEnt"))
rocICS_qda_T<-list()
...
###JUST PASS
#PS layer
predPS_jp_qda_T<-jackPredQDA(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt"))
rocPS_jp_qda_T<-list()
...
####Rank def. problem####
#CD layer
#predCD_jp_qda_T<-jackPredQDA(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt"))
#rocCD_jp_qda_T<-list()
...
#ICS layer
predICS_jp_qda_T<-jackPredQDA(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt"))
...
######H models######
#PS layer
predPS_qda_H<-jackPredQDA(centPS,predictors = c("fci_pre_c","gender","cohort", "Hide"))
rocPS_qda_H<-list()
...
##CD layer
predCD_qda_H<-jackPredQDA(centCD,predictors = c("fci_pre_c","gender","cohort", "Hide"))
rocCD_qda_H<-list()
...
#ICS layer
predICS_qda_H<-jackPredQDA(centICS,predictors = c("fci_pre_c","gender","cohort", "Hide"))
rocICS_qda_H<-list()
...
###JUST PASS
predPS_jp_qda_H<-jackPredQDA(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort", "Hide"))
rocPS_jp_qda_H<-list()
...
predCD_jp_qda_H<-jackPredQDA(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort", "Hide"))
rocCD_jp_qda_H<-list()
...
predICS_jp_qda_H<-jackPredQDA(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort", "Hide"))
...
######PR models######
#PS layer
predPS_qda_P<-jackPredQDA(centPS,predictors = c("fci_pre_c","gender","cohort","PageRank"))
rocPS_qda_P<-list()
...
##CD layer
predCD_qda_P<-jackPredQDA(centCD,predictors = c("fci_pre_c","gender","cohort","PageRank"))
rocCD_qda_P<-list()
...
#ICS layer
predICS_qda_P<-jackPredQDA(centICS,predictors = c("fci_pre_c","gender","cohort","PageRank"))
rocICS_qda_P<-list()
...
###JUST PASS
#PS layer
predPS_jp_qda_P<-jackPredQDA(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank"))
rocPS_jp_qda_P<-list()
...
#CD layer
predCD_jp_qda_P<-jackPredQDA(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank"))
rocCD_jp_qda_P<-list()
...
#ICS layer
predICS_jp_qda_P<-jackPredQDA(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank"))
...
####PLOTTING####
pdf(file = "plots/ROC_AUC_plots/AUC10_NetworkMeasuresFCI_C_Gender_Cohort_qda_weightedMeans.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,2))
x<-c(1:7)
...
dev.off()
####ROC curves####
pdf(file = "plots/ROC_AUC_plots/ROC10_qda_pf.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 14) # The height of the plot in inches
par(mfrow=c(4,2))
...
dev.off()
pdf(file = "plots/ROC_AUC_plots/ROC10_qda_jpf.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 14) # The height of the plot in inches
par(mfrow=c(4,2))
...
ROC_PS_knn_PTH<-list()
for(i in 1:20){
  predPS_knn_PTH<-jackPredKNN(centPS,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"),nK = i)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PTH_PS.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
ROC_CD_knn_PTH<-list()
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"),nK = i)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PTH_CD.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"),nK = i)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PTH_ICS.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"),nK = i)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PTH_PS_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PTH_CD_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt", "Hide"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PTH_ICS_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
ROC_PS_knn_PT<-list()
for(i in 1:20){
  predPS_knn_PT<-jackPredKNN(centPS,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"),nK = i)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PT_PS.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
ROC_CD_knn_PT<-list()
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
  ROC_CD_knn_PT[[i]]<-ROC
}
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PT_CD.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
ROC_ICS_knn_PT<-list()
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS,predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PT_ICS.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PT_PS_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PT_CD_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PT_ICS_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
ROC_PS_knn_TH<-list()
for(i in 1:20){
  predPS_knn_TH<-jackPredKNN(centPS,predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"),nK = i)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_TH_PS.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
ROC_CD_knn_TH<-list()
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD,predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
  ROC_CD_knn_TH[[i]]<-ROC
}
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_TH_CD.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
ROC_ICS_knn_TH<-list()
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS,predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_TH_ICS.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_TH_PS_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_TH_CD_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt", "Hide"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_TH_ICS_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
ROC_PS_knn_PH<-list()
for(i in 1:20){
  predPS_knn_PH<-jackPredKNN(centPS,predictors = c("fci_pre_c","gender","cohort","PageRank","Hide"),nK = i)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PH_PS.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
ROC_CD_knn_PH<-list()
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD,predictors = c("fci_pre_c","gender","cohort","PageRank","Hide"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
  ROC_CD_knn_PH[[i]]<-ROC
}
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PH_CD.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
ROC_ICS_knn_PH<-list()
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS,predictors = c("fci_pre_c","gender","cohort","PageRank","Hide"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PH_ICS.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","Hide"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PH_PS_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","Hide"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PH_CD_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank","Hide"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_PH_ICS_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
ROC_PS_knn_P<-list()
for(i in 1:20){
  predPS_knn_P<-jackPredKNN(centPS,predictors = c("fci_pre_c","gender","cohort","PageRank"),nK = i)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_P_PS.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
ROC_CD_knn_P<-list()
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD,predictors = c("fci_pre_c","gender","cohort","PageRank"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
  ROC_CD_knn_P[[i]]<-ROC
}
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_P_CD.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
ROC_ICS_knn_P<-list()
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS,predictors = c("fci_pre_c","gender","cohort","PageRank"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
  ROC_ICS_knn_P[[i]]<-ROC
}
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_P_ICS.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_P_PS_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_P_CD_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","PageRank"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_P_ICS_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
ROC_PS_knn_T<-list()
for(i in 1:20){
  predPS_knn_T<-jackPredKNN(centPS,predictors = c("fci_pre_c","gender","cohort","tarEnt"),nK = i)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_T_PS.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
ROC_CD_knn_T<-list()
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD,predictors = c("fci_pre_c","gender","cohort","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
  ROC_CD_knn_T[[i]]<-ROC
}
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_T_CD.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
ROC_ICS_knn_T<-list()
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS,predictors = c("fci_pre_c","gender","cohort","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
  ROC_ICS_knn_T[[i]]<-ROC
}
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_T_ICS.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_T_PS_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_T_CD_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","tarEnt"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_T_ICS_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
ROC_PS_knn_H<-list()
for(i in 1:20){
  predPS_knn_H<-jackPredKNN(centPS,predictors = c("fci_pre_c","gender","cohort","Hide"),nK = i)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_H_PS.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
ROC_CD_knn_H<-list()
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD,predictors = c("fci_pre_c","gender","cohort","Hide"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
  ROC_CD_knn_H[[i]]<-ROC
}
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_H_CD.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
ROC_ICS_knn_H<-list()
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS,predictors = c("fci_pre_c","gender","cohort","Hide"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
  ROC_ICS_knn_H[[i]]<-ROC
}
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_H_ICS.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
y<-c(1:20)
...
for(i in 1:20){
  predPS_x<-jackPredKNN(centPS,outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","Hide"),nK = i)
  ROC<-ROCplusWeeks(predPS_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_H_PS_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
for(i in 1:20){
  predCD_x<-jackPredKNN(centCD, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","Hide"),nK = i)
  ROC<-ROCplusWeeks(predCD_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_H_CD_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
for(i in 1:20){
  predICS_x<-jackPredKNN(centICS, outcome = "justpass",predictors = c("fci_pre_c","gender","cohort","Hide"),nK = i)
  ROC<-ROCplusWeeks(predICS_x$allpred)
...
pdf(file = "plots/KNN_plots/SR10_NetworkMeasures_FCI_C_Gender_Cohort_knn_H_ICS_jp.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,3))
...
####PLOTTING####
pdf(file = "plots/ROC_AUC_plots/SR10_NetworkMeasuresFCI_C_Gender_Cohort_knn_weightedMeans.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 4) # The height of the plot in inches
par(mfrow=c(1,2))
x<-c(1:7)
