...
# Predict pass/fail
predPS <- jackPredQDA(centPS)
predCD <- jackPredQDA(centCD)
predICS <- jackPredQDA(centICS)

# Predict just-pass/just-fail (2/0)
predJustPS <- jackPredQDA(centPS, outcome = "justpass")
predJustCD <- jackPredQDA(centCD, outcome = "justpass")
predJustICS <- jackPredQDA(centICS, outcome = "justpass")
